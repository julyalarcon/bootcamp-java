...
public final class Patrones {
	 ...
	 * System.out.println(esClave("Qwert1234")); } catch (PatronExcepcion e) {
	 * e.printStackTrace(); }
	 * 
	 * try { System.out.println(esCorreo("pepitoperez@hotmail.com")); } catch
	 * (PatronExcepcion e) { e.printStackTrace(); }
	 * 
	 * }
	 */
